...
$tgl_trans = $this->input->get('tgl_trans')?$this->input->get('tgl_trans'):date('d/m/Y');
...
<section class="wrapper">
	<div class="breadcrumb margin-bottom-10">
		...
		<div class="bar-nav pull-right ">
			<a class="btn btn-default" href="<?php echo base_url("angsuran/terimabank_list");?>"><i class='fa fa-list-ul'></i> Terima Bank List</a>
		</div>
	</div>
	<form id="terimbankForm" action="<?php echo base_url('angsuran/terimabank_simpan');?>" class="bucket-form" method="post">
		<input class="form-control" id="akhir" name="akhir" type="hidden" value="<?php //echo $saldo_akhir;?>" />
		<div class="col-lg-12 padding-left-right-10">
			<div class="panel margin-bottom-10">
				<div class="panel-heading panel-custom">
						<i class="fa fa-list fa-fw"></i> Transaksi Bank
				...
				<div class="panel-body panel-body-border" style="display: show;">
					<div class="row">
						...
						<div class="col-xs-6 col-sm-3 col-md-3">
							<div class="form-group">
								...
								<input class="form-control" id="kd_bank" name="kd_bank" value="" placeholder="Kode bank" type="text"/>
							</div>
						</div>
						<div class="col-xs-6 col-sm-3 col-md-3">
							<div class="form-group">
								<label>No. Rekening</label>
								<input class="form-control" id="no_rekening" name="no_rekening" placeholder="Nomor rekening" type="text" required readonly />
							</div>
						</div>
						<div class="col-xs-6 col-sm-3 col-sm-3">
							<div class="form-group">
								<label>Kode Perkiraan</label>
								<input class="form-control" id="kd_akun" name="kd_akun" placeholder="Kode Perkiraan" type="text" required />
							</div>
						</div>
						<div class="col-xs-6 col-sm-3 col-sm-3 hidden">
							<div class="form-group">
								<label>Kode Perkiraan</label>
						...
						<!-- <div class="col-xs-6 col-sm-2 col-md-2">
							<div class="form-group">
								...
								<div class="input-group input-append date">
									<input class="form-control" id="tgl_trans" name="tgl_trans" placeholder="DD/MM/YYYY" value="<?php echo $tgl_trans; ?>" type="text" required readonly/>
					...
					<div class="row">
						<div class="col-xs-6 col-sm-2 col-md-2 no-margin-r">
							<div class="form-group">
								<label class="control-label" for="date">Tanggal Trans</label>
								<div class="input-group input-append date">
									<input class="form-control" id="tgl_trans" name="tgl_trans" placeholder="DD/MM/YYYY" value="<?php echo $tgl_trans; ?>" type="text" required/>
									<span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-2 col-md-2 no-margin-l no-margin-r">
							<div class="form-group">
								...
								<input class="form-control" id="kd_trans" name="kd_trans" placeholder="Kode trans" type="text"/>
							</div>
						</div>
						<div class="col-xs-6 col-sm-5 col-md-5 no-margin-l no-margin-r">
							<div class="form-group">
								<label>Uraian Transaksi</label>
								<input autocomplete="off" class="form-control" id="keterangan" name="keterangan" placeholder="Keterngan trans" type="text" required/>
							</div>
						</div>
						<div class="col-xs-6 col-sm-2 col-md-2 no-margin-l no-margin-r">
							<div class="form-group">
								...
								<div class="input-group">
									<input class="form-control" id="jumlah" name="jumlah" placeholder="jumlah" type="text" required/>
									<span class="input-group-btn"><button id="store-btn" class="btn btn-primary" type="button" onclick="storePengajuan();"><i class="fa fa-plus"></i></button></span>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-1 col-md-1 no-margin-l">
							<div class="form-group">
								<label>Tipe</label>
								<input class="form-control hidden" id="tipe" name="tipe" placeholder="Nama trans" type="text" required readonly />
										...
										?>
											<tr id="l_<?php echo $n;?>">
												...
												<td class='text-center'>
													<a title="hapus" onclick="__hapus('<?php echo $value->IDS;?>','<?php echo $n;?>');"><i class='fa fa-trash'></i></a>
												</td>
