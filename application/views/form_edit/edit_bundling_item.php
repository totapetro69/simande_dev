		...
		<div class="form-group">
				<label>Kode Item</label>
					<select name="type_bundling" class="form-control" disabled>
					  ...
					  <option value="<?php echo $value->KD_TYPEMOTOR?>-<?php echo $value->KD_WARNA;?>" <?php echo ($value->KD_TYPEMOTOR == $list->message[0]->TYPE_BUNDLING && $value->KD_WARNA == $list->message[0]->KD_WARNA? "selected" : "");?>><?php echo $value->KD_TYPEMOTOR;?> - <?php echo $value->NAMA_TYPEMOTOR;?> - <?php echo $value->NAMA_PASAR;?> - <?php echo $value->KET_WARNA;?></option>
