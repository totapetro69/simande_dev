...
<div class="modal-body">
	<form id="addForm" class="bucket-form" action="<?php echo base_url('motor/add_detail_bundling_simpan');?>" method="post">
		<input type="hidden" id="status_bundling" type="text" name="status_bundling" value="Aksesoris" class="form-control" >
		...
		<div class="form-group">
				<label>Kode Item</label>
					<select name="type_bundling" class="form-control">
					  ...
					  <option value="<?php echo $value->KD_AKSESORIS;?>"><?php echo $value->NAMA_AKSESORIS;?></option>
