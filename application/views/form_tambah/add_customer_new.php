...
<section class="wrapper">
    <form id="addFormx" action="<?php echo base_url('customer/add_customer_simpan'); ?>" method="post">
        <div class="breadcrumb margin-bottom-10">
            <?php echo breadcrumb();?>
            <div class="bar-nav pull-right">
                <a class="btn btn-default" id="baru"><i class="fa fa-file-o fa-fw"></i> Baru </a>
                <a id="submit-btn" type="button" class="btn btn-default submit-btn <?php echo $status_c;?>"><i class="fa fa-save fa-fw"></i> Simpan</a>
                                    ...
                                    <div class="col-sm-7">
                                        <form class="form-inline">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="kd_customer" id="kd_customer" class="form-control" placeholder="AUTO GENERATE" readonly aria-describedby="addon">
                                            </div>
                                        </form>
                                    </div>
                                    <!-- <div class="col-sm-5">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_customer" id="nama_customer" class="form-control" placeholder="Masukkan Nama Customer" required="required">
                                            </div>
                                            <!-- tgl npwp -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="alamat_surat" id="alamat_surat" rows="3" class="form-control" placeholder="Masukkan Alamat Surat" ></textarea>
                                            </div>
                                            <!-- propinsi -->
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-xs-6 col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label>No. KTP</label>
                                                <input type="text" name="no_ktp" id="no_ktp" class="form-control input-number" placeholder="Masukkan No. KTP" > <!-- di ubah tgl 13/09 -->
                                            </div>
                                            <!-- tgl lahir -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>No. HP</label>
                                                <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="Masukkan No. HP" required="required" >
                                            </div>
                                        </div>
                                    </div>
                                <!-- </form> -->
                                ...
                                <!-- <form class="formCSD" method="post" action=""> -->
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_penanggungjawab" id="nama_penanggungjawab" class="form-control" placeholder="Masukkan Nama Penanggung Jawab" >
                                        </div>
                                        <!-- status rumah -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="upline" name="upline" value=''>
                                        </div>
                                    </div>
                                <!-- </form> -->
                            </div>
