...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">List Kabupaten</h4>
</div>
                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < count($databaru); $i++) {
                            ...
                            if ($compare != 0) {
                                ...
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td class="table-nowarp"><?php echo $databaru[$i]["kode"]; ?></td>
                                    <td class="table-nowarp"><?php echo str_replace("'","",rtrim($databaru[$i]["kabupatenkota"])); ?></td>
                                </tr>
                                <?php
                                //create new array();
...
<div class="modal-footer">
    ...
    <button type="button" id="submit-btn" class="btn btn-danger <?php echo ($totalData==0)?'hidden':'';?>" 
        onclick="AddDataJSON('<?php echo base_url("company/update_kabupaten");?>')"><i class='fa fa-chevron-up'></i> Update Kabupaten<lable class='badge'><?php echo $totalData;?></label>
    </button>
