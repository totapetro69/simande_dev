...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">List Provinsi</h4>
</div>
                        ...
                        for ($i = 0; $i < count($databaru); $i++) {
                            ...
                            if ($compare != 0) {
                                ...
                                <tr>
                                    ...
                                    <td class="table-nowarp"><?php echo str_replace("'","",rtrim($databaru[$i]["provinsi"])); ?></td>
                                </tr>
                                <?php
                                //create new array();
...
<div class="modal-footer">
    ...
    <button type="button" id="submit-btn" class="btn btn-danger <?php echo ($totalData==0)?'hidden':'';?>" 
        onclick="AddDataJSON('<?php echo base_url("company/update_propinsi");?>')"><i class='fa fa-chevron-up'></i> Update Provinsi<lable class='badge'><?php echo $totalData;?></label>
    </button>
