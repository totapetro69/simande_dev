<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">List Sales Program Leasing</h4>
</div>
                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < count($databaru); $i++) {
                            ...
                            for ($n = 0; $n < count($datalokal); $n++) {
								...
								$compare += strcasecmp($datalokal[$n]["NILAI_LEASING"], $databaru[$i]["nilail"]);
								//$compare += strcasecmp($datalokal[$n]["KLASIFIKASI_LEASING"], $databaru[$i]["klasifikasi"]);
                                if ($compare == 0) {
                                    continue 2;
                                }
                            }*/
                            ...
                            if ($compare != 0) {
                                ...
                                <tr>
                                    ...
                                    <td class="table-nowarp"><?php echo $databaru[$i]["nilail"]; ?></td>
                                    <td class="table-nowarp"><?php echo $databaru[$i]["klasifikasi"]; ?></td>
                                </tr>
                                <?php
                                //create new array();
...
<div class="modal-footer">
    ...
    <button type="button" id="submit-btn" class="btn btn-danger <?php echo ($totalData == 0) ? 'hidden' : ''; ?>" 
            onclick="AddDataJSON('<?php echo base_url("setup/update_salesprogramleasing"); ?>')">Update Data (<?php echo $totalData; ?>)</button>
</div>
