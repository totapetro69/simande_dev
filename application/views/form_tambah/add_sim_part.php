<form action="#" id="import-form" class="bucket-form" enctype="multipart/form-data">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Upload File .PDSIM</h4>
    </div>

    <div class="modal-body">
        <div class="form-group">
            <label>Select File .PDSIM </label>
            <div class="input-group input-append">
                <input accept=".pdsim" type="file" id="file" class="custom-file-control form-control" name="file" placeholder="Choose file">
...
<script>
        $(function(){
            ...
            $('#import-form').on('submit',function(e){
                ...
                var url_gm = '<?php echo base_url("part/import_sim_part");?>';
                $.ajax({
                    url: url_gm,
                    type: 'POST',
                    method: 'POST',
