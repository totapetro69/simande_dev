...
?>
  ...
  <div class="breadcrumb margin-bottom-10">
    ...
    <div class="bar-nav pull-right ">
      ...
      <a id="modal-button" class="btn btn-default <?php echo $status_c?>" onclick='addForm("<?php echo base_url('setup/add_insentif'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
  ...
  <div class="col-lg-12 padding-left-right-10">
    ...
    <div class="panel margin-bottom-10">
      ...
      <div class="panel-body panel-body-border" style="display: none;">
        ...
        <form id="filterForm" action="<?php echo base_url('setup/insentif') ?>" class="bucket-form" method="get">

          <div id="ajax-url" url="<?php echo base_url('setup/insentif_typeahead');?>"></div>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
              <div class="form-group">
                ...
                <input type="text" id="keyword" name="keyword" value="<?php echo $this->input->get('keyword'); ?>" class="form-control" placeholder="Masukkan kode motor" autocomplete="off">
              </div>
            </div>
        ...
        ?>
            ...
            <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
              ...
              <td class="table-nowarp">
                <a id="modal-button" onclick='addForm("<?php echo base_url('setup/edit_insentif/'.$row->ID.'/'.$row->ROW_STATUS); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static" class="<?php echo $status_v?>">
                  <i data-toggle="tooltip" data-placement="left" title="edit" class="fa fa-edit text-success text-active"></i>
                </a>
				<?php 
											if($row->ROW_STATUS == 0){ 
											?>
                <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('setup/delete_insentif/'.$row->ID); ?>">
              ...
              <td><?php echo number_format($row->KHUSUS,0);?></td>
