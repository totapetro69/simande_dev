  ...
  <div class="breadcrumb margin-bottom-10">
    <div id="bc1" class="myBreadcrumb">
      ...
      <!-- <div>...</div> -->
      <a href="javascript:void(0);"><div>Dealer</div></a>
      <a href="javascript:void(0);" class="active"><div>Sales Program</div></a>
    </div>

    <div class="bar-nav pull-right ">
      <a id="modal-button" class="btn btn-default" onclick='addForm("<?php echo base_url('dealer/add_salesprogram'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
  ...
  <div class="col-lg-12 padding-left-right-10">
    <div class="panel margin-bottom-10">
      ...
      <div class="panel-body panel-body-border" style="display: none;">
        <form id="filterForm" action="<?php echo base_url('dealer/salesprogram') ?>" class="bucket-form" method="get">
          <div id="ajax-url" url="<?php echo base_url('dealer/salesprogram_typeahead');?>"></div>
          <div class="row">
        ...
        ?>
            ...
            <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
              ...
              <td class="table-nowarp">
                <a id="modal-button" onclick='addForm("<?php echo base_url('dealer/edit_salesprogram/'.$row->KD_SALESPROGRAM); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
                  <i data-toggle="tooltip" data-placement="left" title="edit" class="fa fa-edit text-success text-active"></i>
                </a>
                <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('dealer/delete_salesprogram/'.$row->KD_SALESPROGRAM); ?>">
              ...
              <td><?php echo $row->NAMA_SALESPROGRAM;?></td>
