  ...
  <div class="col-lg-12 padding-left-right-10">
    ...
    <div class="panel margin-bottom-10">
      ...
      <div class="panel-body panel-body-border">
        ...
        <form id="filterForm" action="<?php echo base_url('setup/targeth3dealer') ?>" class="bucket-form" method="get">

          <div id="ajax-url" url="<?php echo base_url('setup/targeth3dealer_typeahead');?>"></div>
        ...
        ?>
            ...
            <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
              ...
              <td class="table-nowarp">
                <a id="modal-button" onclick='addForm("<?php echo base_url('setup/edit_targeth3dealer/'.$row->ID.'/'.$row->ROW_STATUS); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static" class="<?php echo $status_v?>">
                  <i data-toggle="tooltip" data-placement="left" title="edit" class="fa fa-edit text-success text-active"></i>
                </a>
				<?php 
											if($row->ROW_STATUS == 0){ 
											?>
                <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('setup/delete_targeth3dealer/'.$row->ID); ?>">
