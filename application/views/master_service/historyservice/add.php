<form action="#" id="import-form" class="bucket-form">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Histori Service Terakhir</h4>
    </div>
 
    <div class="modal-body">
 
        <div class="form-group">
            <label class="custom-file col-xs-12">Select File .SDHS </label>
            <div class="input-group-append">
                <input accept=".sdhs" type="file" id="file" class="custom-file-control form-control" name="file" placeholder="Choose file">
...
<script>
        $(function(){
            ...
            $('#import-form').on('submit',function(e){
                ...
                var url_gm = '<?php echo base_url("master_service/import_historiservice");?>';
                $.ajax({
                    url: url_gm,
                    type: 'POST',
                    method: 'POST',
