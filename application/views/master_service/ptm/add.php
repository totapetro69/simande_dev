<form action="#" id="import-form" class="bucket-form" enctype="multipart/form-data">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Master Tipe Motor Part</h4>
    </div>

    <div class="modal-body">
        <div class="form-group">
            <label>Select File .PTM </label>
            <div class="input-group input-append">
                <input accept=".ptm" type="file" id="file" class="custom-file-control form-control" name="file" placeholder="Choose file">
...
<script>
        $(function(){
            ...
            $('#import-form').on('submit',function(e){
                ...
                var url_gm = '<?php echo base_url("master_service/import_ptm");?>';
                $.ajax({
                    url: url_gm,
                    type: 'POST',
                    method: 'POST',
