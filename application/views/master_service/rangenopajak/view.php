...
<section class="wrapper">
  ...
  <div class="breadcrumb margin-bottom-10">
   ...
   <div class="bar-nav pull-right ">
    ...
    <a id="modal-button" class="btn btn-default <?php echo $status_c?>" onclick='addForm("<?php echo base_url('master_service/add_rangenopajak'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
      <i class="fa fa-file-o fa-fw"></i>Add Range Pajak
    </a>
...
<div class="col-lg-12 padding-left-right-10">
  ...
  <div class="panel margin-bottom-10">
    ...
    <div class="panel-body panel-body-border" style="display: none;">
      ...
      <form id="filterForm" action="<?php echo base_url('master_service/rangenopajak') ?>" class="bucket-form" method="get">
              ...
              foreach($list->message as $key=>$row): 
                ...
                <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
                  ...
                  <td class="table-nowarp">
                    ...
                    <a id="modal-button" onclick='addForm("<?php echo base_url('master_service/edit_rangenopajak/'.$row->ID.'/'.$row->ROW_STATUS); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static" class="<?php echo $status_v?>">
                      <i data-toggle="tooltip" data-placement="left" title="edit" class="fa fa-edit text-success text-active"></i>
                    </a>
                    <?php 
                    if($row->ROW_STATUS == 0){ 
                      ?>
                      <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('master_service/delete_rangenopajak/'.$row->ID); ?>">
