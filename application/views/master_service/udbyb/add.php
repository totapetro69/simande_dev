<form action="#" id="import-form" class="bucket-form" enctype="multipart/form-data">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah UDBYB</h4>
    </div>

    <div class="modal-body">
        <div class="form-group">
            <label class="custom-file col-xs-12">Select File .UDBYB </label>
            <div class="input-group-append">
                <input accept=".udbyb" type="file" id="file" class="custom-file-control form-control" name="file" placeholder="Choose file">
...
<script>
        $(function(){
            ...
            $('#import-form').on('submit',function(e){
                ...
                var url_gm = '<?php echo base_url("laporan/import_udbyb");?>';
                $.ajax({
                    url: url_gm,
                    type: 'POST',
                    method: 'POST',
