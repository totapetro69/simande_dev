...
<section class="wrapper">
    ...
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right ">
            <a id="modal-button" class="btn btn-default <?php echo  $status_c ?>" onclick='addForm("<?php echo base_url('reminder_booking/add_service_reminder'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
                <i class="fa fa-gear fa-fw"></i> Service Reminder
            </a>
