...
?>
<form id="addForm" class="bucket-form" action="<?php echo base_url('reminder_booking/service_reminder_simpan');?>" method="post">

<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <h4 class="modal-title" id="myModalLabel">Service Reminder</h4>
</div>
