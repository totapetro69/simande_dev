...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Rekap Insentif K.Ops</h4>
</div>
    ...
    <div class="col-lg-12 padding-left-right-5">
            <div class="panel margin-bottom-5">
                ...
                <div class="panel-body panel-body-border panel-body-10" style="display: block;">
                    <form id="filterForms" method="GET" action="<?php echo base_url("laporan_insentif/tambah_insentif_kops");?>">
                        <div class="row">
