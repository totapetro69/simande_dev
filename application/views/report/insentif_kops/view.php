...
<section class="wrapper">
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right">
            <a  class="btn btn-default" href="<?php echo base_url('laporan_insentif/add_insentif_kops?'); ?>kd_dealer=<?php echo $this->input->get('kd_dealer'); ?>"><i class="fa fa-file-o fa-fw"></i> Tambah</a>
            <a class="btn btn-default" id="modal-button" onclick='addForm("<?php echo base_url("Laporan_insentif/insentif_salesman_kops_print");?>?<?php echo $_SERVER["QUERY_STRING"];?>")' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static"><i class="fa fa-print"></i> Print</a>
        </div>
    ...
    <div class="col-lg-12 padding-left-right-5">
        <div class="panel margin-bottom-5">
            <div class="panel-heading">
               <i class="fa fa-list-ul fa-fw"></i> Lap. Insentif K.Ops 
            ...
            <div class="panel-body panel-body-border panel-body-10" style="display: block;">
                <form id="filterForms" method="GET" action="<?php echo base_url("laporan_insentif/insentif_kops");?>">
                    <div class="row">
                                        ...
                                        foreach ($list->message as $key => $value) {
                                            ...
                                            ?>
                                                <tr id="<?php echo  $this->session->flashdata('tr-active') == $value->ID ? 'tr-active' : ' '; ?>" >
                                                    ...
                                                    <td><!-- <a href="<?php echo base_url("Laporan_insentif/insentif_k_salesman");?>?kd_dealer=<?php echo $defaultDealer;?>&nik_salesman=<?php echo $value->ATASAN_LANGSUNG;?>&tgl_awal=<?php echo $this->input->get('tgl_awal');?>&tgl_akhir=<?php echo $this->input->get('tgl_akhir');?>" class="active">
                                                            <i class='fa fa-print' data-toggle="tooltip" data-placement="left" title="cetak insentif" >Insentif</i>
                                                        </a>  -->

                                                        <a href="<?php echo base_url("Laporan_insentif/penalty_kops");?>?kd_dealer=<?php echo $defaultDealer;?>&tgl_awal=<?php echo$value->PERIODE_AWAL;?>&tgl_akhir=<?php echo $value->PERIODE_AKHIR;?>" class="active">
                                                            <i class='fa fa-print' data-toggle="tooltip" data-placement="left" title="cetak penalty" >Penalty</i>
                                                        </a>
                                                         <a href="<?php echo base_url("Laporan_insentif/detail_insentif_kops");?>?insentif_kops_id=<?php echo $value->ID;?>" class="active">
                                                            <i class='fa fa-print' data-toggle="tooltip" data-placement="left" title="detail" >Detail</i>
                                                        </a>
                                                        <a href="<?php echo base_url("Laporan_insentif/exclude_kops");?>?kd_dealer=<?php echo $defaultDealer;?>&tgl_awal=<?php echo$value->PERIODE_AWAL;?>&tgl_akhir=<?php echo $value->PERIODE_AKHIR;?>" class="active">
