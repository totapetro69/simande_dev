...
?>
  ...
  <div class="breadcrumb margin-bottom-10">
    ...
    <div class="bar-nav pull-right ">
      ...
      <a id="modal-button" class="btn btn-default <?php echo $status_c?>" onclick='addForm("<?php echo base_url('setup/add_targeth3dealer'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
  ...
  <div class="col-lg-12 padding-left-right-10">
    ...
    <div class="panel margin-bottom-10">
      ...
      <div class="panel-heading">
          List Pengajuan Insentif PIC Part
      ...
      <div class="panel-body panel-body-border">
        ...
        <form id="filterForm" action="<?php echo base_url('setup/listpengajuan_insentifpicpart') ?>" class="bucket-form" method="get">
        ...
        ?>
            ...
            <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
              ...
              <td class="table-nowarp">
                <a id="modal-button" onclick='addForm("<?php echo base_url('setup/approvepengajuan_insentifpicpart/'.$row->NO_PROSES); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static" class="<?php echo $status_v?>">
                  <i data-toggle="tooltip" data-placement="left" title="approve" class="fa fa-check"></i>
                </a>
				<?php 
											if($row->ROW_STATUS == 0){ 
											?>
                <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('setup/deletepengajuan_insentifpicpart/'.$row->NO_PROSES); ?>">
...
<script type="text/javascript">
	...
	function __approval(kd_dealer){
            ...
            $.post("<?php echo base_url();?>setup/approve_targeth3dealer/"+kd_dealer,function(result){
                console.log(result);
