...
<section class="wrapper">
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right">
            <a class="btn btn-default" id="modal-button" onclick='addForm("<?php echo base_url("Laporan_insentif/rekap_insentif_counter_print");?>?<?php echo $_SERVER["QUERY_STRING"];?>")' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static"><i class="fa fa-print"></i> Print</a>
        </div>
    ...
    <div class="col-lg-12 padding-left-right-5">
        <div class="panel margin-bottom-5">
            <div class="panel-heading">
               <i class="fa fa-list-ul fa-fw"></i> Rekap Insentif Sales Counter 
            ...
            <div class="panel-body panel-body-border panel-body-10" style="display: block;">
                <form id="filterForms" method="GET" action="<?php echo base_url("laporan_insentif/rekap_insentif_counter");?>">
                    <div class="row">
                        ...
                        <tbody>
                            ...
                            if(isset($list_k_sales)){
                                    if($list_k_sales->totaldata >0){
                                        ...
                                        foreach ($list_k->message as $key => $value) {
                                            $n++;
                                            //$part=explode("-",$value->URAIAN_TRANSAKSI,2);
                                            //$insentif = ($value->TYPE_PENJUALAN =='CREDIT' )? number_format($value->KREDIT,0) :number_format($value->CASH,0);
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                             ...
                                                             <a href="<?php echo base_url("Laporan_insentif/insentif_k_counter");?>?kd_dealer=<?php echo $defaultDealer;?>&nik_salesman=<?php echo $value->ATASAN_LANGSUNG;?>&tgl_awal=<?php echo $this->input->get('tgl_awal');?>&tgl_akhir=<?php echo $this->input->get('tgl_akhir');?>" class="active">
                                                            <i class='fa fa-print' data-toggle="tooltip" data-placement="left" title="cetak insentif" >Insentif</i>
                                                        </a> 

                                                        <a href="<?php echo base_url("Laporan_insentif/rekap_penalty_counter");?>?kd_dealer=<?php echo $defaultDealer;?>&nik_salesman=<?php echo $value->ATASAN_LANGSUNG;?>&tgl_awal=<?php echo $this->input->get('tgl_awal');?>&tgl_akhir=<?php echo $this->input->get('tgl_akhir');?>" class="active">
