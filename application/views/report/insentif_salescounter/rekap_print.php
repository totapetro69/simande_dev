...
<div class="modal-body" id="printarea">
    ...
    <table  border="0" id="desc" class="">
        <tr>            
            <td  align="center" colspan="11"><h2><strong>Rekap Insentif Sales Counter</strong></h2></td>
        </tr>
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th  style="text-align: center !important">Nama Sales Counter</th>
                ...
                if (is_array($list->message) || is_object($list->message)){
                    ...
                    foreach ($list->message as $key => $value) {
                        ...
                        <tr>
                            ...
                            $kategori =($value->PERSONAL_JABATAN =='Counter Sales' || $value->PERSONAL_JABATAN =='Sales Counter')? 'Reguler':''; 
                    ...
                    if ($list_k_counter->totaldata > 0) {
                        foreach ($list_k_counter->message as $key => $value) {
                          $n++;                                
                        ?>
                        <tr>
                            <td class='text-center table-nowarp'><?php echo $n;?></td>                                                   
                            <?php                            
                            $kategori = ($value->PERSONAL_JABATAN =='Kepala Counter')?'Reguler':''; 
                            ?>
                            <td class='table-nowarp'><?php echo $kategori;?></td>
                            <td class='table-nowarp'><?php echo $value->NAMA_SALES;?></td>
                           <!--  <td class='table-nowarp'><?php echo $value->NAMA_ATASAN;?></td> -->
