...
<section class="wrapper">
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right">
            <a class="btn btn-default" id="modal-button" onclick='addForm("<?php echo base_url("Laporan_insentif/insentif_counter_print");?>?<?php echo $_SERVER["QUERY_STRING"];?>")' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static"><i class="fa fa-print"></i> Print</a>
        </div>
    ...
    <div class="col-lg-12 padding-left-right-5">
        <div class="panel margin-bottom-5">
            <div class="panel-heading">
               <i class="fa fa-list-ul fa-fw"></i> Lap. Insentif Sales Counter 
            ...
            <div class="panel-body panel-body-border panel-body-10" style="display: block;">
                <form id="filterForms" method="GET" action="<?php echo base_url("laporan_insentif/insentif_counter");?>">
                    <div class="row">
                        <div class="col-xs-6 col-md-3 col-sm-3">
                         ...
                         <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                               <label>Nama Sales Counter <span id="l_salesman"></span></label>
                                <select class="form-control" id="kd_salesman" name="kd_salesman" title="getCounter" required="true">
