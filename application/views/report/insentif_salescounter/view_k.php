...
<section class="wrapper">
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right">
            <a class="btn btn-default" id="modal-button" onclick='addForm("<?php echo base_url("Laporan_insentif/insentif_k_counter_print");?>?<?php echo $_SERVER["QUERY_STRING"];?>")' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static"><i class="fa fa-print"></i> Print</a>
        </div>
    ...
    <div class="col-lg-12 padding-left-right-5">
        <div class="panel margin-bottom-5">
            <div class="panel-heading">
               <i class="fa fa-list-ul fa-fw"></i> Lap. Insentif Kepala Counter 
                            ...
                            <div class="form-group">
                               <label>Nama Kepala Counter <span id="l_salesman"></span></label>
                                <select class="form-control" id="kd_salesman" name="nik_salesman" title="getKSalesman" required="true">
                                    <?php echo ($sales->totaldata >= 1)? "<option value='".$sales->message[0]->NIK."'>".$sales->message[0]->NAMA_SALES."</option>" : "<option value='0'>--Pilih K Counter--</option>";?>
