...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Laporan Insentif Kepala Salesman</h4>
</div>
...
<div class="modal-body" id="printarea">
    ...
    <table  border="0" id="desc" class="">
        <tr>            
            <td  align="center" colspan="11"><h2><strong>Laporan Insentif Kepala Salesman</strong></h2></td>
        </tr>
