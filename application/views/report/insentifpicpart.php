...
<section class="wrapper">
   <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right ">
             ...
             <a id="proses" class="btn btn-info" >
                  
                <i class='fa fa-print fa-fw' data-toggle="tooltip" data-placement="left" title="Print" ></i> Proses Pengajuan
            </a>
            
             <a class="btn btn-info" href="<?php echo base_url('report/insentifpicpart_print?q=' . $this->input->get("q") . '&tahun=' . $this->input->get("tahun")); ?> "target="_blank">
