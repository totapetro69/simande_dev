...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Laporan Pengeluaran Barang</h4>
</div>
...
<div class="modal-body" id="printarea">
    <table style="border: none;" id="desc" border="0" >
      <tr>
        ...
        <td style="text-align: center; width:300px !important;"><h4 style="margin:0 0 5px 0;"><strong>Laporan Pengeluaran Barang</strong></h4><br><span style="font-size: 10px;">Periode : <?php echo $dtgl; ?> s/d <?php echo $stgl; ?></span>
        </td>
