...
<section class="wrapper">
  <div class="breadcrumb margin-bottom-10">
    ...
    <div class="bar-nav pull-right ">
      <a class="btn btn-default  <?php echo $status_p ?>" id="modal-button" onclick='addForm("<?php echo base_url('report/lap_pinjaman_stnk_print?keyword=' . $this->input->get("keyword") . '&row_status=' . $this->input->get("row_status") . '&page='. $this->input->get("page")); ?>");'  role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
  ...
  <div class="col-lg-12 padding-left-right-10">
    <div class="panel margin-bottom-10">
      <div class="panel-heading">
        <MAIN>Laporan Pinjaman STNK</MAIN> 
      ...
      <div class="panel-body panel-body-border" >
        <form id="filterFormz" action="<?php echo base_url('report/lap_pinjaman_stnk') ?>" class="bucket-form" method="get">
          <div class="row">
