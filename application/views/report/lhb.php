...
<section class="wrapper">
   <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right ">
            ...
            <a class="btn btn-info" href="<?php echo base_url('report/lhb?p=1&kd_dealer='.$defaultDealer.'&tgl_awal=' .$tgl_awal. '&tgl_akhir=' .$tgl_akhir); ?> "target="_blank" class="<?php echo $status_p?>">
   ...
   <div class="col-lg-12 padding-left-right-10 ">
      <div class="panel margin-bottom-10">
         ...
         <div class="panel-body panel-body-border" >
            <form id="filterFormz" action="<?php echo base_url('report/lhb') ?>" class="bucket-form" method="get">
               <div class="row">
