...
<main>
  <table border='1' class="table-full table-border" style="border-collapse: collapse;">
    <thead>
      <tr>
        <th rowspan="3" style="text-align: center!important; width:5px !important;">NO</th>
        <th style="text-align: center; width:12px !important;" rowspan="3">No. PKB</th>
        <th style="text-align: center; width:8px" rowspan="3">Tanggal</th>
        <th style="text-align: center; width:8px;" rowspan="3">Nopol</th>
        <th style="text-align: center; width:28px;" rowspan="3">Mekanik</th>
        ...
        if (($list->totaldata >0 )) {
          foreach ($list->message as $key => $value) {
            ...
            <tr>
              ...
              <td style="white-space: nowrap !important;"><?php echo ($value->NO_PKB);?></td>
              <td style=" width:8px !important"><?php echo tglFromSql($value->TANGGAL_PKB);?></td>
              <td style="white-space: nowrap !important;"><?php echo ($value->NO_POLISI);?></td>
              <td style="white-space: nowrap !important;"><?php echo ($value->NAMA);?></td>
