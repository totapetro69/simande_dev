...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Laporan Penerimaan NRFS</h4>
</div>
...
<div class="modal-body" id="printarea">
    ...
    <table id="desc" >
            ...
            <tr>
                <td colspan="12"><h2><strong>Laporan Penerimaan NFRS</strong></h2></td>
            </tr>

            <tr>
                <td colspan="12">Periode : <?php echo ($this->input->get("tgl_awal")) ? $this->input->get("tgl_awal") : date('d-m-Y', strtotime('first day of this month')); ?> s/d <?php echo($this->input->get("tgl_akhir")) ? $this->input->get("tgl_akhir") : date('d/m/Y'); ?></td>
                <!--<td></td>-->
            </tr>
    ...
    <table id="desc" class="table table-striped table-bordered">
            ...
            <tr style="border-bottom: 1px solid; border-top: 1px solid;" class="text-center">
                ...
                <th colspan="6" style="text-align: center;">No Terima SJ</th>
