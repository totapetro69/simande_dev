...
<!-- </div>  -->
  ...
  <div class="breadcrumb margin-bottom-10">
    ...
    <div class="bar-nav pull-right ">
      ...
      <a class="btn btn-default <?php echo $status_p;?>" href="<?php echo base_url('report_pengajuan/pengajuan_xls/'.$reff_data.'?jenis='.$this->input->get("jenis").'&tahun='.$this->input->get("tahun")); ?>">
          <i class="fa fa-file-text fa-fw"></i> File Excel
      </a>

      <a class="btn btn-default <?php echo $status_p;?>" href="<?php echo base_url('report_pengajuan/pengajuan_pdf/'.$reff_data.'?jenis='.$this->input->get("jenis").'&tahun='.$this->input->get("tahun")); ?>" target="_blank">
          <i class="fa fa-print fa-fw"></i> Cetak <?php echo $reff;?>
      </a>
  ...
  <div class="col-lg-12 padding-left-right-10">
    ...
    <div class="panel margin-bottom-10">
      ...
      <div class="panel-heading">
          <i class="fa fa-list fa-fw"></i> Pengurusan <?php echo $reff;?>
      ...
      <div class="panel-body panel-body-border" style="display: show;">
        ...
        <form id="filterForm" action="<?php echo base_url('report_pengajuan/laporan_pengajuan/'.$reff_data) ?>" class="bucket-form" method="get">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-7">
              <div class="form-group">
                  <label>Jenis <?php echo $reff;?></label>
                  <select name="jenis" id="jenis" class="form-control">
                    <!-- <option value="2" <?php echo ($this->input->get('keterangan')==2)?" selected":" ";?> >
                      BPKB
                    </option> -->
                    <!-- <option>-- Pilih <?php echo $reff;?> --</option> -->

                    <option value="1" <?php echo ($this->input->get('jenis')==1?" selected":" ");?>>
                      <?php echo ($reff == 'STNK'?'Laporan STNK belum selesai':'Laporan BPKB belum diterima Cabang');?>
                    </option>
                    <option value="2" <?php echo ($this->input->get('jenis')==2?" selected":" ");?>>
                      <?php echo ($reff == 'STNK'?'Laporan STNK belum diserahkan ke konsumen':'Laporan BPKB belum diserahkan ke konsumen');?>
                    </option>
