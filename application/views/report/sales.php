                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="pilih" class="form-control">
                                    ...
                                    <option value="6" <?php echo ($pilih == 6 ? "selected" : ""); ?>>Kategori Motor</option>
                                    <option value="1" <?php echo ($pilih == 1 ? "selected" : ""); ?>>Motor 9 Segmen</option>
                                    <option value="2" <?php echo ($pilih == 2 ? "selected" : ""); ?>>Tunai - Kredit</option>
                                    <option value="3" <?php echo ($pilih == 3 ? "selected" : ""); ?>>Kode Customer</option>
                                    <option value="4" <?php echo ($pilih == 4 ? "selected" : ""); ?>>Lokasi Penjualan</option>
                                    <option value="5" <?php echo ($pilih == 5 ? "selected" : ""); ?>>Honda ID/ People Sales Performance</option>
                                </select>
                            </div>
                        </div>
                    </div>
