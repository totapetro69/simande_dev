...
<section class="wrapper">
    ...
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right ">
            ...
            <a class="btn btn-default <?php echo $status_p ?>" id="modal-button" onclick='addForm("<?php echo base_url('report_penerimaan/selisih_penerimaan_print?kd_dealer='.$this->input->get("kd_dealer").'&tgl_awal=' . $this->input->get("tgl_awal") . '&tgl_akhir=' . $this->input->get("tgl_akhir")); ?>");'  role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
    ...
    <div class="col-lg-12 padding-left-right-10">
        ...
        <div class="panel margin-bottom-10">
            ...
            <div class="panel-body panel-body-border" style="display: block;">
                ...
                <form id="penerimaanForm" action="<?php echo base_url('report_penerimaan/selisih_penerimaan') ?>" class="bucket-form" method="get">
                ...
                <table class="table table-bordered table-hover b-t b-light">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th colspan="5" style="text-align: center;">Nomor Shipping List</th>
                            <th colspan="6" style="text-align: center;">Tanggal Shipping</th>
                        </tr>
                        <tr>                            
                            <th>KD Tipe Unit</th>
                            ...
                            if (is_array($list->message) || is_object($list->message)):
                                foreach ($list->message as $key => $group_row):
                                    ...
                                    <tr class="info bold">
                                        ...
                                        <td colspan="6" style="text-align: center;"><?php echo $group_row->NO_SJMASUK; ?></td>
