...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Laporan Insentif Kepala Counter</h4>
</div>
...
<div class="modal-body" id="printarea">
    ...
    <table border='0' id="desc" class="">
        ...
        <tr>
            <td colspan="12"><h3><strong>FORM PERSETUJUAN PENGAJUAN INSENTIVE SALES COUNTER</strong></h3></td>
        </tr>
        ...
        <tr>
            <td colspan="2">Nama Sales Counter</td>
            <td align='center'> : </td>
            <td colspan="9"></td>
        </tr>
        <tr>
