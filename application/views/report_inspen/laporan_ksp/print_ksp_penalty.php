...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Laporan Penalti KSP</h4>
</div>
...
<div class="modal-body" id="printarea">
    ...
    <table border='0' id="desc" class="">
        ...
        <tr>
            <td colspan="12"><h3><strong>REKAPITULASI PENALTI INSENTIVE KSP</strong></h3></td>
        </tr>
        ...
        <tr style="border-bottom: 1px solid; border-top: 1px solid;">
            ...
            <th rowspan="2">KSP - Unit</th>
            <th rowspan="2">KSP - AR</th>
