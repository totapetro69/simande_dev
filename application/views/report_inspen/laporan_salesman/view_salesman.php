...
<section class="wrapper">
    ...
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right ">
            ...
            <a class="btn btn-default <?php echo $status_p ?>" id="modal-button" onclick='addForm("<?php echo base_url('report_inspen/print_salesman'); ?>");'  role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
    ...
    <div class="col-lg-12 padding-left-right-10">
        ...
        <div class="panel margin-bottom-10">
            ...
            <div class="panel-body panel-body-border" style="display: block;">
                ...
                <form id="penerimaanForm" action="<?php echo base_url('report_inspen/laporan_salesman') ?>" class="bucket-form" method="get">
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Kategori</th>
                            <th>Nama Salesman</th>
                            <th>Koord. Salesman</th>
                            <th>Target</th>
                            <th>Jual</th>
                            <th>Total Jual</th>
                            <th>Capai</th>
                            <th>Insentif Dasar</th>
                            <th>Pengali</th>
                            <th>Insentif</th>
                            <th>Tambahan</th>
                            <th>Ins. Admin</th>
