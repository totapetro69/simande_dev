  ...
  <div class="breadcrumb margin-bottom-10">
    <div id="bc1" class="myBreadcrumb">
      ...
      <a href="javascript:void(0);" class="active"><div>Divisi</div></a>
    </div>

    <div class="bar-nav pull-right ">

      <a id="modal-button" class="btn btn-default" onclick='addForm("<?php echo base_url('company/add_divisi'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
        ...
        ?>
            ...
            <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
              ...
              <td class="table-nowarp">
                <a id="modal-button" onclick='addForm("<?php echo base_url('company/edit_divisi/'.$row->KD_DIV); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
                  <i data-toggle="tooltip" data-placement="left" title="edit" class="fa fa-edit text-success text-active"></i>
                </a>
                <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('company/delete_divisi/'.$row->KD_DIV); ?>">
                  <i data-toggle="tooltip" data-placement="left" title="hapus" class="fa fa-trash text-danger text"></i>
                </a>
              </td>
              <td><?php echo $row->KD_DIV;?></td>
