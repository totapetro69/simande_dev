...
if(isset($list)){
  if($list->totaldata>0){
    foreach ($list->message as $key => $value) {
        ...
        //$tgl_akhir = TglFromSql($value->TGL_AKHIR);
        $id=$value->ID;
    }
  }
...
<form id="addForm" class="bucket-form" action="<?php echo base_url('company/ks_bawahan_simpan');?>" method="post">
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-xs-12 col-md-12">   
        ...
        <div class="form-group">
          <label>NIK</label>
          <input id="nik" name="nik" type="text" class="form-control" placeholder="Masukkan nik karyawan"  required>
        </div>
        <div class="form-group">
          <label>Nama Karyawan</label>
          <input type="text" id="nama_karyawan" name="nama_karyawan" value="" class="form-control disabled-action" placeholder="Masukkan nama karyawan">
        </div>
        <div class="form-group">
