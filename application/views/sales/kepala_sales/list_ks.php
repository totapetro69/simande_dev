...
<section class="wrapper">
  ...
  <div class="breadcrumb margin-bottom-10">
   ...
   <div class="bar-nav pull-right ">
    ...
    <a id="modal-button" class="btn btn-default <?php echo $status_c?>" onclick='addForm("<?php echo base_url('company/add_ks'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
   ...
   <div class="col-lg-12 padding-left-right-10">
      ...
      <div class="panel-body panel-body-border" style="display: none;">
         ...
         <form id="filterForm" action="<?php echo base_url('company/ks') ?>" class="bucket-form" method="get">

            <div id="ajax-url" url="<?php echo base_url('company/ks_typeahead'); ?>"></div>
            <div class="row">
               ...
               <tbody>
                ...
                <tr id="<?php echo $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' ';?>" >
                  ...
                  <td class="table-nowarp">
                     <a href="<?php echo base_url('company/ks_bawahan/' . $row->ID); ?>" role="button" class="<?php echo  $status_v ?>">
                      <i data-toggle="tooltip" data-placement="left" title="Detail" class="fa fa-eye text-success text-active"></i>
                    </a>
                    <a id="modal-button" onclick='addForm("<?php echo base_url('company/edit_ks/'.$row->ID.'/'.$row->ROW_STATUS); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static" class="<?php echo $status_v?>">
                      <i data-toggle="tooltip" data-placement="left" title="edit" class="fa fa-edit text-success text-active"></i>
                   </a>
                    <?php 
                    if($row->ROW_STATUS == 0){ 
                      ?>
                      <a id="delete-btn<?php echo $no;?>" class="delete-btn" url="<?php echo base_url('company/delete_ks/'.$row->ID); ?>">
                    ...
                    ?>
                     ...
                     <td class="table-nowarp"><?php echo $row->NAMA_LOKASI; ?></td>
