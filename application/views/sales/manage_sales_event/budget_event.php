...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="myModalLabel">Budget event</h4>
</div>

<div class="modal-body">
  <form id="addForm" class="bucket-form" method="post" action="<?php echo base_url('sales_event/update_budget/' . $list->message[0]->KD_EVENT); ?>">
    <input id="id" type="hidden" name="id" value="<?php echo $list->message[0]->KD_EVENT; ?>">
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input type="text" style="text-transform:uppercase" name="kd_budget" id="kd_budget" class="form-control" value="<?php echo  $list->message[0]->KD_BUDGET; ?>">
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input type="text" name="jumlah_budget" id="jumlah_budget" class="form-control" value="<?php echo  $list->message[0]->JUMLAH_BUDGET; ?>" >
        </div>
      </div>
