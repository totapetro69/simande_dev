      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <div class="input-group input-append date" id="date">
            <input type="text" class="form-control" id="tanggal" name="tanggal" value="<?php echo ($list->message[0]->TANGGAL)?tglfromSql($list->message[0]->TANGGAL): date('d/m/Y');?>" placeholder="dd/mm/yyyy" required="required" / >
    ...
    <div class="row">
      ...
      <!-- <div class="col-sm-2">
        <div class="form-group">
          ...
          <input type="text" name="unit_to_display" id="unit_to_display" class="form-control" value="<?php echo  $list->message[0]->UNIT_TO_DISPLAY; ?>" >
        </div>
      </div> -->
