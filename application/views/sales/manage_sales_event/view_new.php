              ...
              if (($list->totaldata >0 )) {
                foreach ($list->message as $key => $value) {
                  ...
                  <tr id="<?php echo $this->session->flashdata('tr-active') == $value->ID ? 'tr-active' : ' ';?>" >
                    ...
                    <a href="<?php echo base_url('sales_event/add_event_new/' . $value->ID); ?>" role="button" class="<?php echo  $status_v ?>">
                      <i data-toggle="tooltip" data-placement="left" title="Input Detil" class="fa fa-eye text-success text-active"></i>
                    </a>
                    <a href="<?php echo base_url('sales_event/approval_event/' . $value->ID); ?>" role="button" class="<?php echo  $status_v ?>">
                      <i data-toggle="tooltip" data-placement="left" title="Approve/ Reject" class="glyphicon glyphicon-ok text-success text-active"></i>
                    </a>
                    <?php 
