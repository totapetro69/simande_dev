            ...
            <tr class="info bold">
              ...
              <td>
               ...
               <!--  <a href="<?php echo base_url('sales_order/add_sales_order?n='.urlencode(base64_encode($group_row->NO_SO))); ?>" class="<?php echo $status_v?>">
                ...
                <!-- <a href="<?php echo base_url('sales_order/faktur_penjualan/'.$group_row->ID); ?>" target="_blank" class="<?php echo $status_p?>">
                  <i data-toggle="tooltip" data-placement="left" title="Faktur Penjualan" class="fa fa-list-alt text-warning text"></i>
                </a> -->
                <!-- <a href="<?php echo base_url('sales_order/faktur_stnk/'.$group_row->ID); ?>" target="_blank" class="<?php echo $status_p?>">
                  <i data-toggle="tooltip" data-placement="left" title="Faktur STNK" class="fa fa-list-alt text-warning text"></i>
                </a> -->

                <!-- <a class="<?php echo $status_e?>" url="">
