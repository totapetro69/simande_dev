                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < count($databaru); $i++) {
                            ...
                            if ($compare != 0) {
                                ...
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td class="table-nowarp"><?php echo $databaru[$i]["idsales"]; ?></td>
                                    <td class="table-nowarp"><?php echo str_replace("'","",rtrim($databaru[$i]["nmsales"])); ?></td>
                                    <td class="table-nowarp"><?php echo $databaru[$i]["hondaid"]; ?></td>
...
<!-- <<<<<<< HEAD -->
    ...
    <button type="button" id="submit-btn" class="btn btn-danger <?php echo ($totalData==0)?'hidden':'';?>" 
        onclick="AddDataJSON('<?php echo base_url("dealer/update_salesman");?>')"><i class='fa fa-chevron-up'></i> Update Salesman <lable class='badge'><?php echo $totalData;?></label>
    </button>
