...
<section class="wrapper">
    <div class="breadcrumb margin-bottom-10">
        ...
        <div class="bar-nav pull-right ">
            ...
            <a id="modal-button" class="btn btn-default" onclick='addForm("<?php echo base_url('Setup/add_diskon'); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
    ...
    <div class="col-lg-12 padding-left-right-10">
        ...
        <div class="panel margin-bottom-10">
            ...
            <div class="panel-body panel-body-border" style="display: none;">
                ...
                <form id="filterForm" action="<?php echo base_url('Setup/diskon') ?>" class="bucket-form" method="get">

                    <div id="ajax-url" url="<?php echo base_url('Setup/diskon_typeahead'); ?>"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Masukkan kode atau nama diskon" autocomplete="off">
                            </div>
                                ...
                                foreach ($list->message as $key => $row):
                                    ...
                                    <tr id="<?php echo  $this->session->flashdata('tr-active') == $row->ID ? 'tr-active' : ' '; ?>" >
                                        ...
                                        <td class="table-nowarp">
                                            <a id="modal-button" onclick='addForm("<?php echo base_url('Setup/edit_diskon/' . $row->KD_DISKON.'/'.$row->ROW_STATUS); ?>");' role="button" data-toggle="modal" data-target="#myModalLg" data-backdrop="static">
                                                <i data-toggle="tooltip" data-placement="left" title="Ubah" class="fa fa-edit text-success text-active"></i>
                                            </a>
											<?php 
											if($row->ROW_STATUS == 0){ 
											?>
                                            <a id="delete-btn<?php echo  $no; ?>" class="delete-btn" url="<?php echo base_url('Setup/delete_diskon/' . $row->KD_DISKON); ?>">
