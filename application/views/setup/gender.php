...
<section class="wrapper">
    <div class="breadcrumb margin-bottom-10">
        ...
        <div id="bc1" class="myBreadcrumb">
            ...
            <a href="javascript:void(0);" class="active"><div>Jenis Kelamin</div></a>
        </div>
    ...
    <div class="col-lg-12 padding-left-right-10">
        ...
        <div class="panel margin-bottom-10">
            ...
            <div class="panel-body panel-body-border" style="display: none;">
                ...
                <form id="filterForm" action="<?php echo base_url('Setup/gender') ?>" class="bucket-form" method="get">

                    <div id="ajax-url" url="<?php echo base_url('Setup/gendern_typeahead'); ?>"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Masukkan kode atau nama jenis kelamin" autocomplete="off">
                            </div>
