...
<!-- meta data 
=============================================================================================================== -->
<title>Visitors an Admin Panel Category Bootstrap Responsive Website Template | Home :: simande</title>
...
<section id="container">
	...
	<section id="main-content">
		...
		<!--//agileinfo-grap-->
			...
			<!-- //tasks -->
			<div class="agileits-simande-stats">
	 ...
	 <!-- footer -->
			  <div class="footer">
				<div class="wthree-copyright">
				  <p>© Copyright 2017 SiMANDA. All rights reserved</p>
				</div>
			  </div>
	  <!-- / footer -->
	</section>
