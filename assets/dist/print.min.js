! function(e, t) {
    ...
    return function(e) {
        ...
        function r(e, t) {
            ...
            t.showModal && d.a.close(), t.onLoadingEnd && t.onLoadingEnd()
        }
                ...
                send: function(e, t) {
                    ...
                    "pdf" === e.type && (a.a.isIE() || a.a.isEdge()) ? n.setAttribute("onload", r(n, e)) : t.onload = function() {
                        if ("pdf" === e.type) r(n, e);
                            ...
                            t.document && (t = t.document), t.body.innerHTML = e.htmlData, "image" === e.type ? i(t, e).then(function() {
                                r(n, e)
                            }) : r(n, e)
                        }
                    }
        ...
        function o(e, t) {
            ...
            if (n.getComputedStyle) {
                ...
                var o = t.targetStyles || ["border", "box", "break", "text-decoration"],
                ...
                for (var d = 0; d < r.length; d++)
                    for (var l = 0; l < o.length; l++) "*" !== o[l] && -1 === r[d].indexOf(o[l]) && -1 === a.indexOf(r[d]) || (i += r[d] + ":" + r.getPropertyValue(r[d]) + ";")
            } else if (e.currentStyle) {
                r = e.currentStyle;
                for (var s in r) - 1 !== r.indexOf("border") && -1 !== r.indexOf("color") && (i += s + ":" + r[s] + ";")
            }
            return i += "max-width: " + t.maxWidth + "px !important;" + t.font_size + " !important;"
        }
            ...
            for (var n = 0; n < e.length; n++) {
                ...
                if (-1 === t.ignoreElements.indexOf(r.getAttribute("id"))) {
                    ...
                    if ("INPUT" === i || "TEXTAREA" === i || "SELECT" === i) {
                        ...
                        c.appendChild(s), c.setAttribute("style", d), l.appendChild(c), l.removeChild(r)
        ...
        t.a = {
            print: function(e, t) {
                ...
                a.appendChild(o.cloneNode(!0)), a.setAttribute("style", "height:0; overflow:hidden;"), a.setAttribute("id", "printJS-html"), o.parentNode.appendChild(a), a = document.getElementById("printJS-html"), a.setAttribute("style", n.i(r.c)(a, e) + "margin:0 !important;");
                var d = a.children;
                n.i(r.d)(d, e), e.header && n.i(r.e)(a, e.header, e.headerStyle), a.parentNode.removeChild(a), e.htmlData = n.i(r.a)(a.innerHTML, e), i.a.send(e, t)
            }
        }
    }, function(e, t, n) {
        "use strict";
        ...
        t.a = {
            init: function() {
                ...
                var u = void 0;
                switch (u = document.createElement("iframe"), u.setAttribute("style", "visibility: hidden; height: 0; width: 0; position: absolute;"), u.setAttribute("id", e.frameId), "pdf" !== e.type && (u.srcdoc = "<html><head><title>" + e.documentTitle + "</title></head><body></body></html>"), e.type) {
                    case "pdf":
        ...
        function r(e) {
            for (var t = e.printable, r = e.properties, o = '<table style="border-collapse: collapse; width: 100%;"><thead><tr>', a = 0; a < r.length; a++) o += '<th style="width:' + 100 / r.length + "%; " + e.gridHeaderStyle + '">' + n.i(i.b)(r[a]) + "</th>";
            o += "</tr></thead><tbody>";
        ...
        t.a = {
            print: function(e, t) {
                if (e.showModal || e.onLoadingStart) {
                    var n = new window.XMLHttpRequest;
                    n.addEventListener("load", r(e, t)), n.open("GET", -1 !== e.printable.indexOf("http") ? e.printable : window.location.origin + "/" + e.printable, !0), n.send()
                } else r(e, t)
            }
        }
    }, function(e, t, n) {
